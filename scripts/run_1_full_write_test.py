...
Order confirm) on one fresh WO, end to end, in a single pass -- exercising the real production code
path (not the individual pieces tested separately by run_5_stage_b_submit_test.py and
run_vo_confirm_test.py).
